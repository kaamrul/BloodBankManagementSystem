...
$camp_id = $_GET['camp_id'];
	$camp = $conn->prepare("SELECT * FROM tbl_camp_info,tbl_blood_bank_info where tbl_camp_info.bank_id=tbl_blood_bank_info.bank_id and tbl_camp_info.camp_id='$camp_id'");
	$camp->execute();
	$camp_value = $camp->fetch(PDO::FETCH_ASSOC);
if (isset($_POST['btn'])) {
    $area = $_POST['area'];
    $venue = $_POST['venue'];
    $time = $_POST['time'];
	...
	if (!empty($area) && !empty($venue) && !empty($time) && !empty($date) && !empty($unit) && !empty($phone)) {
			try{	
				$sql = "update tbl_camp_info set camp_area='$area',venue='$venue',time='$time',date='$date',unit='$unit',contact_no='$phone' where camp_id='$camp_id'";
				...
				<form method="post" action="#">
					...
					<div class="col-sm-6">
						<div class="form-group">
							...
							<div>
								<input type="text" class="form-control" placeholder="Enter Camp Area" name="area" id="area" value="<?php echo $camp_value['camp_area']; ?>">
							</div>
						</div>
					</div>
					...
					<div class="col-sm-6">
						<div class="form-group">
							...
							<div>
							<input type="text" class="form-control" name="venue" id="venue" placeholder="Enter Venue" value="<?php echo $camp_value['venue']; ?>">
							</div>
						</div>
					</div>
					...
					<div class="col-sm-6">
						<div class="form-group">
							...
							<div>
								<input type="time" class="form-control" name="time" id="time" placeholder="Enter Time" value="<?php echo $camp_value['time']; ?>">
							</div>
						</div>
					</div>
					...
					<div class="col-sm-6">
						<div class="form-group">
							...
							<div> 
								<input type="date" class="form-control" name="date" id="date" placeholder="Enter Date:" value="<?php echo $camp_value['date']; ?>">
							</div>
						</div>
					</div>
					...
					<div class="col-sm-6">
						<div class="form-group">
							...
							<div> 
								<input type="count" class="form-control" name="unit" id="unit" placeholder="Enter Unit" value="<?php echo $camp_value['unit']; ?>">
							</div>
						</div>
					</div>
					...
					<div class="col-sm-6">
						<div class="form-group">
							...
							<div> 
								<input type="phone" class="form-control" name="phone" id="phone" placeholder="Enter Contact No.." value="<?php echo $camp_value['contact_no']; ?>">
							</div>
						</div>
					</div>  
